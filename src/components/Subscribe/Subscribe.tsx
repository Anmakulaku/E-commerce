...
export function Subscribe() {
  ...
  return (
    <section className='subscribe section__margin'>
      <div className='subscribe__grid'>
        <div className='subscribe__img'>
          <picture>
            ...
            <img
              src={subscribe1}
              alt='Man smiling, promoting newsletter subscription'
              className='subscribe__imgMan'
              loading='lazy'
            />
          </picture>
        </div>
        ...
        <div className='subscribe__img'>
          <picture>
            ...
            <img
              src={subscribe2}
              alt='Woman smiling, promoting newsletter subscription'
      ...
      <SubscribeModal isVisible={isSubscribed} onCloseClick={onCloseClick} />
    </section>
  );
}
